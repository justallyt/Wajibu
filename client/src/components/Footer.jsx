                         ...
                         <div className="footer-content">
                                    ...
                                    <div className="footer-content-row">
                                                ...
                                                <div className="footer-column">
                                                           ...
                                                           <ul>
                                                                     <li><NavLink to={'/services/'}>Website Development</NavLink></li>
                                                                     <li><NavLink to={'/services/'}>MVP Development</NavLink></li>
                                                                     <li><NavLink to={'/services/'}>Ecommerce Web Solutions</NavLink></li>
                                                                     <li><NavLink to={'/services/'}>Search Engine Optimization</NavLink></li>
                                                                     <li><NavLink to={'/services/'}>Website Maintenance Services</NavLink></li>
                                                                     <li><NavLink to={'/services/'}>Website Revamp</NavLink></li>
                                                             </ul>
                                                </div>
